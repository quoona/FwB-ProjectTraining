...
namespace FwB.Discount.Controllers
{
    public class DiscountController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DiscountId,DiscountName,Content,Status")] DiscountModel discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiscountId,DiscountName,Content,Status")] DiscountModel discount)
        {
